...
cn=ms.connect(host="localhost",user="root",passwd="muditjain")
cur=cn.cursor()
#creating database for hospital
cur.execute("create database if not exists XYZ_hospital")
cur.execute("use XYZ_hospital")
...
while r!=4:
    ...
    if r==1:
      ...
      print("Thank you for using XYZ Hospital App, Have a nice day!")
      break
